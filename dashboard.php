                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-tables">
                                            <a href="rmFlow/rmFlow.php" class="dropdown-item">Monthly</a>
...
<!--                                    <a href="production/cuttingOutput" class="dropdown-item">Cutting Output</a>-->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
<!--                                    <a href="https://reports.moko.co.ke/demandPlanning/RawMaterials" class="dropdown-item">Overall Projections</a>-->
                                    <a href="https://reports.moko.co.ke/demandPlanning/proj" class="dropdown-item">Sales Projections</a>
                                    <a href="https://reports.moko.co.ke/demandPlanning/bom" class="dropdown-item">BOM</a>
                                    <a href="https://reports.moko.co.ke/demandPlanning/RawMaterials" class="dropdown-item">Consumption Projections</a>
                                    <a href="https://reports.moko.co.ke/demandPlanning/catMix" class="dropdown-item">Category Mix</a>
                                </div>
                            </li>
                        </ul>
                    </div>
